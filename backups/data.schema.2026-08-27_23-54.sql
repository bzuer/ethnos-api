...
-- ------------------------------------------------------
-- Server version	11.8.6-MariaDB-5ubuntu0.1 from Ubuntu-log
...
) ENGINE=InnoDB AUTO_INCREMENT=54901603 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2503118 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `metrics_annual_summary`
--

DROP TABLE IF EXISTS `metrics_annual_summary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `multi_manifestation_works`
--

DROP TABLE IF EXISTS `multi_manifestation_works`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5463217 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=11149455 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `pub_isbn13_map`
--

DROP TABLE IF EXISTS `pub_isbn13_map`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `publication_relevance` (
  ...
  `negative_raw` decimal(6,2) NOT NULL DEFAULT 0.00,
  `neg_n` int(11) NOT NULL DEFAULT 0,
  `venue_bonus` decimal(6,2) NOT NULL,
  `corroboration` decimal(6,2) NOT NULL DEFAULT 0.00,
  `direct_n` int(11) NOT NULL DEFAULT 0,
...
CREATE TABLE `publications` (
  ...
  `mohrsiebeck_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `doi` (`doi`),
  ...
  UNIQUE KEY `uq_publications_mohrsiebeck` (`mohrsiebeck_id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1129232453 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=31047487 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Temporary table structure for view `subject_effective_weight`
--

DROP TABLE IF EXISTS `subject_effective_weight`;
/*!50001 DROP VIEW IF EXISTS `subject_effective_weight`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `subject_effective_weight` AS SELECT
 1 AS `subject_id`,
  1 AS `weight`,
  1 AS `is_direct`,
  1 AS `tier` */;
...
CREATE TABLE `subject_relevance_tiers` (
  ...
  `propagates` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Subfield rows only: 0 = catch-all parent, hands NO weight to untiered child Topics (allowlist semantics, §4.7)',
...
) ENGINE=InnoDB AUTO_INCREMENT=2746186 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `venue_isbn13_map`
--

DROP TABLE IF EXISTS `venue_isbn13_map`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `venue_merge_audit`
--

DROP TABLE IF EXISTS `venue_merge_audit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `venue_merge_map`
--

DROP TABLE IF EXISTS `venue_merge_map`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `venues` (
  ...
  `llm_justification` mediumtext DEFAULT NULL,
  ...
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `mohrsiebeck_category_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  UNIQUE KEY `uq_venues_mohrsiebeck_cat` (`mohrsiebeck_category_id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1887183 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `work_references` (
  ...
  `citation_type` enum('POSITIVE','NEUTRAL','NEGATIVE','SELF') DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=174854011 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=24137338 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP FUNCTION IF EXISTS `fn_clean_name_text` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP FUNCTION IF EXISTS `format_to_isbn13` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_build_summary_venues` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
BEGIN
    ...
    INNER JOIN (
        SELECT vs.venue_id AS id,
               SUM(COALESCE(sew.weight, 0)) / COUNT(*) AS sub_score
        FROM venue_subjects vs
        INNER JOIN subjects s ON vs.subject_id = s.id
        LEFT JOIN subject_effective_weight sew ON sew.subject_id = s.id
    ...
    WHERE llm_relevance >= 4
      AND NOT (type = 'SOURCE_BOOK' AND COALESCE(llm_justification,'') LIKE 'Source Book %');
    ...
    UPDATE venues
    SET llm_score = CASE
            WHEN type = 'SOURCE_BOOK'
             AND COALESCE(llm_justification,'') LIKE 'Source Book %' THEN 0
            ELSE COALESCE(llm_relevance,0) * 2
        END
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_change_person_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_collapse_book_pubs_by_isbn` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
BEGIN
    ...
    CREATE TEMPORARY TABLE tmp_pub_pos (
        ...
        positive_signal DECIMAL(6,2) NOT NULL,
        direct_n        INT          NOT NULL,
        has_direct_ab   TINYINT(1)   NOT NULL
    ) ENGINE=InnoDB;

    INSERT INTO tmp_pub_pos (publication_id, positive_signal, direct_n, has_direct_ab)
    SELECT p.id,
           MAX(sew.weight),
           COUNT(DISTINCT IF(sew.is_direct = 1, s.normalized_term, NULL)),
           MAX(sew.is_direct = 1 AND sew.tier IN ('A','B'))
    FROM publications p
    JOIN work_subjects ws ON ws.work_id = p.work_id
    JOIN subject_effective_weight sew ON sew.subject_id = ws.subject_id
    ...
    INSERT INTO tmp_pub_neg (publication_id, negative_signal, neg_n)
    SELECT p.id, MAX(srt.weight), COUNT(DISTINCT s.normalized_term)
    FROM publications p
    JOIN work_subjects ws ON ws.work_id = p.work_id
    ...
    CREATE TEMPORARY TABLE tmp_pub_scored (
        ...
        positive_signal  DECIMAL(6,2) NOT NULL,
        negative_signal  DECIMAL(6,2) NOT NULL,
        negative_raw     DECIMAL(6,2) NOT NULL,
        neg_n            INT          NOT NULL,
        venue_bonus      DECIMAL(6,2) NOT NULL,
        corroboration    DECIMAL(6,2) NOT NULL,
        direct_n         INT          NOT NULL,
        no_signal_flag   TINYINT(1)   NOT NULL,
        KEY idx_class (rel_class),
        KEY idx_score (score)
    ...
    INSERT INTO tmp_pub_scored
        (publication_id, work_id, venue_id, score, rel_class,
         positive_signal, negative_signal, negative_raw, neg_n, venue_bonus,
         corroboration, direct_n, no_signal_flag)
    SELECT
        d.publication_id, d.work_id, d.venue_id,
        ROUND(d.positive_signal + d.corroboration - d.negative_signal
              + d.venue_bonus + d.no_signal_penalty, 2) AS score,
        CASE
            
            
            
            WHEN ROUND(d.positive_signal + d.corroboration - d.negative_signal
                       + d.venue_bonus + d.no_signal_penalty, 2) < 0 THEN 'OFF'
            WHEN d.no_signal_flag = 1                                THEN 'UNSCORED'
            WHEN ROUND(d.positive_signal + d.corroboration - d.negative_signal
                       + d.venue_bonus + d.no_signal_penalty, 2) >= 7 THEN 'CORE'
            WHEN ROUND(d.positive_signal + d.corroboration - d.negative_signal
                       + d.venue_bonus + d.no_signal_penalty, 2) >= 3 THEN 'ADJACENT'
            ELSE 'BORDERLINE'
        END AS rel_class,
        d.positive_signal, d.negative_signal, d.negative_raw, d.neg_n,
        d.venue_bonus, d.corroboration, d.direct_n, d.no_signal_flag
    FROM (
        SELECT
            ...
            COALESCE(pp.direct_n, 0)        AS direct_n,

            
            LEAST(GREATEST(COALESCE(pp.direct_n, 0) - 1, 0) * 0.5, 1.5) AS corroboration,
            ...
            CASE WHEN COALESCE(pp.has_direct_ab, 0) = 1 THEN 0.0
                 WHEN COALESCE(pn.neg_n, 0) < 2          THEN 0.0
                 ELSE COALESCE(pn.negative_signal, 0) END AS negative_signal,
            COALESCE(pn.negative_signal, 0) AS negative_raw,
            COALESCE(pn.neg_n, 0)           AS neg_n,

            CASE
                
                
                WHEN v.type = 'SOURCE_BOOK'
                 AND COALESCE(v.llm_justification,'') LIKE 'Source Book %' THEN 0.0
                WHEN v.llm_relevance >= 4 THEN  1.0
                WHEN v.llm_relevance  = 3 THEN  0.5
                
                
                WHEN v.llm_relevance <= 1
                 AND NOT (v.type = 'SOURCE_BOOK' OR p.type IN ('BOOK','CHAPTER'))
                                          THEN -0.5
                ELSE 0.0
            END AS venue_bonus,

            CASE WHEN pp.publication_id IS NULL AND pn.publication_id IS NULL
                 THEN 1 ELSE 0 END AS no_signal_flag,

            CASE WHEN pp.publication_id IS NULL AND pn.publication_id IS NULL
                      AND v.llm_relevance <= 1
                      AND NOT (v.type = 'SOURCE_BOOK' OR p.type IN ('BOOK','CHAPTER'))
                 THEN -1.0 ELSE 0.0 END AS no_signal_penalty
    ...
    SET @sql_write = CONCAT(
        ...
        '(publication_id, work_id, venue_id, score, rel_class, ',
        ' positive_signal, negative_signal, negative_raw, neg_n, venue_bonus, ',
        ' corroboration, direct_n, no_signal_flag, computed_at) ',
        'SELECT publication_id, work_id, venue_id, score, rel_class, ',
        ' positive_signal, negative_signal, negative_raw, neg_n, venue_bonus, ',
        ' corroboration, direct_n, no_signal_flag, NOW() ',
        'FROM tmp_pub_scored'
    );
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_delete_publication` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_merge_manifestations` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_merge_organizations_by_map` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_merge_persons_list` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_merge_venues_by_map` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_merge_works_by_map` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_populate_metrics_annual_summary` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_populate_organizations_semantic_keys` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_populate_references_counts` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_refresh_subjects_total_works_simple` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_refresh_works_publication_years` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_remove_all_orphans` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_update_all_venue_stats` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_update_organization_bibliometrics` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_update_venues_type_from_aggregation` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_update_venue_bibliometrics` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
--
-- Final view structure for view `subject_effective_weight`
--
...
/*!50001 VIEW `subject_effective_weight` AS select `srt`.`subject_id` AS `subject_id`,`srt`.`weight` AS `weight`,1 AS `is_direct`,`srt`.`tier` AS `tier` from `subject_relevance_tiers` `srt` where `srt`.`tier` in ('A','B','C','D','E','S') union all select `t`.`id` AS `subject_id`,round(`srt`.`weight` * 0.6,2) AS `weight`,0 AS `is_direct`,`srt`.`tier` AS `tier` from ((`subjects` `t` join `subjects` `parent` on(`parent`.`id` = `t`.`parent_id`)) join `subject_relevance_tiers` `srt` on(`srt`.`subject_id` = `parent`.`id` and `srt`.`vocabulary` = 'OpenAlex' and `srt`.`tier` in ('A','B','C','D','S') and `srt`.`propagates` = 1)) where `t`.`vocabulary` = 'OpenAlex' and `t`.`subject_type` = 'Topic' and !exists(select 1 from `subject_relevance_tiers` `o` where `o`.`subject_id` = `t`.`id` limit 1) */;
...
-- Dump completed on 2026-08-27 23:54:25
